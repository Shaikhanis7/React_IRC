...
_(This project's readme.md is generated by_ [_verb_](https://github.com/verbose/verb-generate-readme)_, please don't edit the readme directly. Any changes to the readme must be made in the_ [_.verb.md_](../../../backend/node\_modules/normalize-path/.verb.md) _readme template.)_
...
Copyright © 2018, [Jon Schlinkert](https://github.com/jonschlinkert). Released under the [MIT License](../../../backend/node\_modules/normalize-path/LICENSE/).
