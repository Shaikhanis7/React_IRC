...
As of April 07, 2019, this library runs [>1m test assertions](../../../backend/node\_modules/to-regex-range/test/test.js) against generated regex-ranges to provide brute-force verification that results are correct.
...
_(This project's readme.md is generated by_ [_verb_](https://github.com/verbose/verb-generate-readme)_, please don't edit the readme directly. Any changes to the readme must be made in the_ [_.verb.md_](../../../backend/node\_modules/to-regex-range/.verb.md) _readme template.)_
...
Copyright © 2019, [Jon Schlinkert](https://github.com/jonschlinkert). Released under the [MIT License](../../../backend/node\_modules/to-regex-range/LICENSE/).
